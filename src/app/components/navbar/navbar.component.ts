...
@Component({
  ...
  template: `
    <nav class="w-full fixed top-0 backdrop-blur-xl bg-gradient-to-r from-purple-900/90 to-pink-900/90 border-b border-pink-500/20 z-50 transition-all duration-300">
      <div class="h-[100px] max-w-6xl mx-auto flex justify-between items-center px-6">
        <!-- Logo/Brand -->
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" [class]="isMenuOpen ? 'hidden' : 'block'" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
          </svg>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" [class]="isMenuOpen ? 'block' : 'hidden'" viewBox="0 0 16 16">
        ...
        <div class="hidden md:flex items-center gap-4">
          ...
          <a href="https://www.linkedin.com/in/jonah-carpenter-aa2644264/" 
             target="_blank"
             class="text-white hover:text-pink-400 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
      ...
      <div class="md:hidden overflow-hidden transition-[max-height] duration-300 ease-in-out"
        ...
        <div class="flex flex-col items-center gap-4 px-6 py-4">
          <!-- Social Icons - Mobile -->
          <div class="flex items-center justify-center gap-6 w-full py-2 border-b border-pink-500/20">
            <a href="https://github.com/jonahgcarpenter" 
               target="_blank"
               class="text-white hover:text-pink-400 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
          ...
          <button *ngFor="let section of sections"
                  (click)="selectSection($event, section)"
                  [class]="'w-full px-4 py-3 rounded-lg transition-colors text-white text-lg ' + 
                    (currentSection === section ? 'bg-purple-500' : 'border border-pink-500 hover:bg-pink-500/10')"
          >
            {{ section.toUpperCase() }}
          </button>
